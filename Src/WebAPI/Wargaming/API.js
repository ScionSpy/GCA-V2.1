...
const APIs = {
    wows: 'https://api.worldofwarships.com/',
    api: 'https://clans.worldofwarships.com/'
};
...
module.exports = class Wargaming_API extends WebAPI {
    ...
    #verifyPath(path) {
        ...
        if (path.startsWith('wows')) path = APIs.wows + path;
        else if (path.startsWith('api')) path = APIs.api + path;
