...
PlayerData.getDetails = async function getDetails(query, authToken) {
    ...
    if (authToken && typeof authToken !== "string") throw new Error(`WargamingAPI.Player.getDetails(); 'authToken' must be a string! got ${typeof authToken}`);
...
PlayerData.getClanInfo = async function getClanInfo(query, clanExtra = '', authToken) {
    ...
    if (authToken && typeof authToken !== "string") throw new Error(`WargamingAPI.Player.getClanInfo(); 'authToken' must be a string! got ${typeof authToken}`);
