...
/**
 * Get all text channels that match the query
 * @param {string} query
 * @param {import("discord.js").GuildChannelTypes[]} type
 */
Guild.prototype.findMatchingTextChannels = function (query, type = [ChannelType.GuildText, ChannelType.GuildAnnouncement]) {
...
/**
 * @todo Check if this.clan_id exists.
 * @todo if not, fetch from the DB, otherwise from DB managed cache.
 */
/*Guild.prototype.fetchClan = async function() {
    return
};*/
